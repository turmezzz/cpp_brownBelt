...
{
public:
	explicit Unit(geo2d::Point position) : data_d(position)
	{
	}
...
{
public:
	explicit Building(geo2d::Rectangle geometry) : data_d(geometry)
	{
	}
...
private:
	geo2d::Rectangle data_d;
};

class Tower : public GameObject
{
public:
	explicit Tower(geo2d::Circle geometry) : data_d(geometry)
	{
	}
...
{
public:
	explicit Fence(geo2d::Segment geometry) : data_d(geometry)
	{
	}
...
{
	return geo2d::Collide(data_d, that.GetGeometry());
}
