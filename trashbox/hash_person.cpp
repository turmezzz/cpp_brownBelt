...
struct AddressHasher
{
	...
	{
		return string_hasher_d(address.city) * simple_number_d * simple_number_d +
				string_hasher_d(address.street) * simple_number_d +
				int_hasher_d(address.building);
	}

	size_t simple_number_d = 3571;
	hash <string> string_hasher_d;
	hash <int> int_hasher_d;
};
...
struct PersonHasher
{
	...
	{
		return string_hasher_d(person.name) * simple_number_d * simple_number_d * simple_number_d +
				int_hasher_d(person.height) * simple_number_d * simple_number_d +
				double_hasher_d(person.weight) * simple_number_d +
				address_hasher_d(person.address);
	}

	size_t simple_number_d = 3571;
	hash <string> string_hasher_d;
	hash <double> double_hasher_d;
	hash <int> int_hasher_d;
	AddressHasher address_hasher_d;
};
